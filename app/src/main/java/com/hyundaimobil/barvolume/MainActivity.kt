package com.hyundaimobil.barvolume
    ...
    override fun onClick(v: View) {
        if(v.id == R.id.btn_calculate){
            ...
            if(length == null){
                ...
                edtLength.error = "Field ini harus berupa nomor yang falid"
            }

            if(width == null){
                isInvalidDouble = true
                edtWidth.error = "Field ini harus berupa nomor yang falid"
            }

            if(height == null){
                isInvalidDouble = true
                edtHeight.error = "Field ini harus berupa nomor yang falid"
            }
